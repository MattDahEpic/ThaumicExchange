...
public class InfusionRecipeThaumicExchanger {
    ...
    public static void registerRecipe () {
        ...
        ThaumcraftApi.addInfusionCraftingRecipe("thaumicExchanger", new ItemStack(ThaumicExchange.blockThaumicExchanger, 1), 70, new AspectListPrimalsOnly().getPrimalsXEachList(50), new ItemStack(Blocks.stone, 1), getMaterialsArray());
    }
